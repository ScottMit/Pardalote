...
1. In Arduino IDE: **File → Examples → Pardalote → messaging**, select your board, upload.
2. Open `index.html` in a browser.
3. Type the board's IP into the **Board IP** field and press **Connect** —
   this is a **tool**, so no code editing is needed and the browser remembers
   the IP for next time.
