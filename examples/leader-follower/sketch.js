...
let leaderIpIn, leaderTransport, leaderConnectBtn, leaderDisconnectBtn, leaderRxIn, leaderTxIn;
let followerIpIn, followerTransport, followerConnectBtn, followerDisconnectBtn, followerRxIn, followerTxIn;
...
function boardCtx(key) {
    if (key === 'leader') return {
        ...
        transport: leaderTransport, connectBtn: leaderConnectBtn, disconnectBtn: leaderDisconnectBtn, name: 'Leader',
    ...
    return {
        ...
        transport: followerTransport, connectBtn: followerConnectBtn, disconnectBtn: followerDisconnectBtn, name: 'Follower',
...
function makeBoardRow(main, key) {
    ...
    if (key === 'leader') { leaderTransport = transport; leaderIpIn = ip; leaderConnectBtn = connectBtn; leaderDisconnectBtn = disconnectBtn; leaderRxIn = rx; leaderTxIn = tx; }
    else                  { followerTransport = transport; followerIpIn = ip; followerConnectBtn = connectBtn; followerDisconnectBtn = disconnectBtn; followerRxIn = rx; followerTxIn = tx; }
}
...
function applyTransport(key) {
    const c = boardCtx(key);
    const usb = (c.transport.value() === 'USB');   // WiFi shows the IP field; USB hides it
